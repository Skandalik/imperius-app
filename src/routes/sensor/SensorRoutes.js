    ...
    return (
      <div>
        <Switch>
          ...
          <Route path="/sensor/:id/manual_behaviors/add" component={ManualBehaviorFormPage} key="sensor_manual_behavior_create" />
          <Route path="/sensor/:id/scheduled_behaviors/add" component={ScheduledBehaviorFormPage} key="sensor_scheduled_behavior_create" />
          <Route path="/sensor/:id/manual_behaviors/edit/:behaviorId" component={ManualBehaviorFormPage} key="sensor_manual_behavior_edit" />
          <Route path="/sensor/:id/scheduled_behaviors/edit/:behaviorId" component={ScheduledBehaviorFormPage} key="sensor_scheduled_behavior_edit" />
        </Switch>
      </div>
    );
  }
