...
class ManualBehaviorForm extends React.Component {
    state = {
                        ...
                        <Form onSubmit={handleSubmit} loading={loading} style={padding}>
                            ...
                            <div>
                                <Field name={'requirement'} type={'select'} component={'select'}
                                    ...
                                    {this.getBehaviorOptions(BehaviorRequirementsEnumChoices)}
                                </Field>
                                <Field
                                    parse={parse}
...
export default reduxForm({form: 'manualBehavior', validate})
